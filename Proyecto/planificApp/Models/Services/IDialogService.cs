...
public interface IDialogService
{
    ...
    Task<LocationFormData?> ShowAddLocationDialog(IGeoService geoService);
    Task<LocationFormData?> ShowEditLocationDialog(IGeoService geoService, string nombre, string direccion, string area, string color, string transporte);
